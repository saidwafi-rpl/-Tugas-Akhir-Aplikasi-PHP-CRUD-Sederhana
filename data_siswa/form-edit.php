...
<html>
<head>
    <title>Edit Data Siswa | SMKN 4 Tanjungpinang</title>
</head>
<body>
    <h3>Edit Data Siswa</h3>
    <form action="proses-edit.php" method="POST">
        <!-- Menyimpan ID untuk proses selanjutnta -->
        ...
        <table border="0">
            ...
            <tr>
                <td>Nama Lengkap</td>
                <td>
                    <input type="text" name="namaLengkap" value="<?php echo $siswa['namaLengkap']; ?>" required>
                </td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
